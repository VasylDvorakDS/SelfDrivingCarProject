...
class Canvas(Window):
    ...
    def simulate_generation(self, networks, simulation_round, max_generation_iterations):
        self.hud = Hud(simulation_round, networks[0].dimensions, self.overlay_batch, max_generation_iterations)
        self.car_sprites = []
