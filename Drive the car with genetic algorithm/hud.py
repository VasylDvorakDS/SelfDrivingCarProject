...
class Hud:
    def __init__(self, simulation_round, dimensions, batch, max_generation_iterations):
        self.round_label = Label(f"Round: {simulation_round}/{max_generation_iterations}", x=20, y=520, color=(0, 0, 0, 255), batch=batch)
